...
export default function SobreMim() {
  return (
    ...
    >
      ...
      <p className={styles.paragrafo}>Oi, tudo bem? Eu sou o Bruno Machado, sou aluno de ADS e também sigo a trilha de Front-End da Alura. Atualmente estou me aprofundando em GIT, HTML5, CSS3, SASS, STYLED COMPONENTS, JAVASCRIPT, REACT e TAILWIND.
      </p>
